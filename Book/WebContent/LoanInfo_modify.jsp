...
<TABLE align="center" height="100%" cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD align="left" vAlign=top ><s:form action="LoanInfo/LoanInfo_ModifyLoanInfo.action" method="post" onsubmit="return checkForm();" name="form1">
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
  ...
  <tr>
    <td width=30%>借阅时间:</td>
    <td width=70%><input type="text" readonly  id="loanInfo.borrowTIme"  name="loanInfo.borrowTIme" onclick="setDay(this);" value='<%=loanInfo.getBorrowTIme() %>'/></td>
  </tr>

  <tr>
    <td width=30%>归还时间:</td>
    <td width=70%><input type="text" readonly  id="loanInfo.returnTIme"  name="loanInfo.returnTIme" onclick="setDay(this);" value='<%=loanInfo.getReturnTIme() %>'/></td>
  </tr>
